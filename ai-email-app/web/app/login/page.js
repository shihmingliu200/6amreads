  ...
  return (
    <div className="min-h-screen bg-cream-50 px-6 py-12">
      <div className="mx-auto w-full max-w-md">
        ...
        <h1 className="mt-10 font-serif text-3xl font-semibold text-ink-900">Welcome back</h1>
        <p className="mt-2 text-sm text-ink-700">Sign in to your morning newspaper.</p>
